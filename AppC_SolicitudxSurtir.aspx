...
<script runat="server">
    ...
    Sub CSP_SetSolicitudComprasxFiltro()
        ...
        miParam1.Direction = ParameterDirection.Input
        coDetalle.Parameters.Add(miParam1)
        coDetalle.Parameters("@CSot_Clave").Value = 7 ' Por VoBo
        ...
        If registro.Read Then
            ...
            Response.Write("<script>javascript: alert('Solicitud Surtida');<" & "/" & "script>")
            Server.Transfer("AppC_SolicitudxSurtir.aspx")
        Else

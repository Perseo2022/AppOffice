...
<script runat="server">
    ...
    Sub CSP_SetSolicitudComprasxFiltro()
        ...
        If registro.Read Then
            ...
            Response.Write("<script>javascript: alert('Solicitud Aprobada SA ');<" & "/" & "script>")
            Server.Transfer("AppC_SolicitudxAprobarSA.aspx")
        Else
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Solicitudes / Por Aprobar SA</strong>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Solicitud Clave: <%=Session("Vs_ClaveTexto") & "  " %> Por Aprobar SA</strong>
                                </div>

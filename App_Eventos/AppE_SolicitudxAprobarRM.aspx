            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Solicitudes / Aprobar RM</strong>
                    </div>
                    <div class="card-body">
...
<div id="DvDatos">
  ...
  <div class="form-group mb-2">
    <label for="staticEmail2" class="sr-only">file</label>
    <input type="text" readonly class="form-control-plaintext" id="staticEmail2" value="Archivo Cargado: ">
  </div>
  <div class="form-group mx-sm-3 mb-2">
    <label for="fileName" class="sr-only">name</label>
   <a href="#" id="nameFile" ><p id="fileName"> </p></a> 
  </div>
  <button type="submit" id="viewDoc" class="btn btn-primary mb-2"><i class="fa fa-eye" aria-hidden="true"></i></button>
</div>

...
<script runat="server">
    ...
    Sub SP_GetSolTipo()
        ...
        'El CommandType = StoreProcedure y la conexion
        Dim coDetalle As New SqlCommand
        coDetalle.CommandText = "AppE_SPGetSolTipo"
        coDetalle.CommandType = CommandType.StoredProcedure
        coDetalle.Connection = myConnection  'Previamente definida
        ...
        While registro.Read
            ...
            Select Case registro("Id_Estatus").ToString
                Case "1"
                                                ...
                                                <div class="stat-content">
                                                    <div class="text-left dib">
                                                        <div class="stat-text"><span class="count"><%=vg_xValidar %></span></div>
                                                         <div class="stat-heading"><asp:HyperLink ID="HyperLink15" NavigateUrl ="AppE_SolicitudXValidar.aspx" runat="server">Por Validar</asp:HyperLink></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="stat-content">
                                                    <div class="text-left dib">
                                                        <div class="stat-text"><span class="count"><%=vg_xAprobar %></span></div>
                                                         <div class="stat-heading"><asp:HyperLink ID="HyperLink7" NavigateUrl ="AppE_SolicitudXAprobar.aspx" runat="server">Por Aprobar</asp:HyperLink></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="stat-content">
                                                    <div class="text-left dib">
                                                        <div class="stat-text"><span class="count"><%=vg_xAprobarRM %></span></div>
                                                         <div class="stat-heading"><asp:HyperLink ID="HyperLink4" NavigateUrl ="AppE_SolicitudxAprobarRM.aspx" runat="server">Por Aprobar RM</asp:HyperLink></div>
                                                ...
                                                <div class="stat-content">
                                                    <div class="text-left dib">
                                                        <div class="stat-text"><span class="count"><%=vg_xSurtir %></span></div>
                                                         <div class="stat-heading"><asp:HyperLink ID="HyperLink9" NavigateUrl ="AppE_SolicitudxSurtir.aspx" runat="server">Por Surtir</asp:HyperLink></div>
                                                ...
                                                <div class="stat-content">
                                                    <div class="text-left dib">
                                                        <div class="stat-text"><span class="count"><%=vg_xVoBo %></span></div>
                                                         <div class="stat-heading"><asp:HyperLink ID="HyperLink5" NavigateUrl ="AppE_SolicitudxVoBo.aspx" runat="server">VoBo</asp:HyperLink></div>
                ...
                <script>
                    jQuery(document).ready(function ($) {
                        ...
                        var myChart = new Chart(ctx, {
                            type: 'bar',
                            data: {
                                labels: ["Validar", "Aprobar", "AprobarRM", "Surtir", "VoBo"],
                                datasets: [
                                    {
                                        label: "Total",
                                        data: [<%=(vg_TotxValidar)%>, <%=CInt(vg_TotxAprobar)%>, <%=CInt(vg_TotxAprobarRM)%>, <%=CInt(vg_TotxSurtir)%>, <%=vg_TotVoBo%>],

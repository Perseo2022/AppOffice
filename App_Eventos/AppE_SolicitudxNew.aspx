                ...
                <div class="card">
                  ...
                  <div class="form-row">
                      <div class="form-group col-md-12">
					    ...
					    <div class="input-group">
						    <div class="input-group-addon"><i class="fa fa-th-large"></i></div>
                            <asp:TextBox ID="Observaciones" runat="server" Rows="2" class="form-control" TextMode="MultiLine"></asp:TextBox>
					    </div>
				     </div>
                  </div>
                 <div class="form-row">
	             <div class="form-group col-md-3">
					...
					<div class="input-group">
						<div class="input-group-addon"><i class="fa fa-th-large"></i></div>
						<select id="SelectUMedida" class="form-control">
                            <option value="1">Caja</option>
                            <option value="2">Paquete</option>
                            <option value="3">Pieza</option>
                            <option value="4">Sin Unidad</option>
						</select>
					</div>
				</div>
				<div class="form-group col-md-3">
					...
					<div class="input-group">
						<div class="input-group-addon"><i class="fa fa-id-card" aria-hidden="true"></i></div>
						<input type="text" value = "0" class="form-control" id="cantidad">
					</div>
				</div>
                     <div class="form-group col-md-3">
					<label class=" form-control-label">Agregar</label>
					<div class="input-group">
			...
			<table id="lista_insumos" class="table table-striped">
				<thead>
					<tr>
						<th>ID_Insumo</th>
						<th> Insumo </th>
						<th style="display: none;"> IdUMedida </th>
						<th> UMedida </th>
						<th> cantidad </th>
						<th> </th>
					</tr>
        ...
        $(document).ready(function () {
            ...
            $('#btnSolicitarEvento').click(function () {
                ...
                var Datos = {
                    ...
                    UbiEdificio: $("#Txt_Edificio").val(),
                    UbiPiso: $("#Txt_Piso").val(),
                    UbiTelefono: $("#Txt_Telefono").val(),
                    UbiExtension: $("#Txt_Extension").val(),

...
<body class="bg-dark" oncontextmenu="return false" onkeydown="return false">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header text-center">
                        <h1><strong class="card-title">Sistema de Registro de Solicitudes</strong></h1>
                    </div>
                                ...
                                <aside class="profile-nav alt">
                                    <section class="card">
                                        <div class="card-header user-header alt bg-dark">
                                            <div class="media">
                                                <a href="#">
                                                    <img class="align-self-center rounded-circle mr-3" style="width:85px; height:85px;" alt="" src="images/logo1.png">
                                                </a>
                                                <div class="media-body">
                                                    <h1 class="text-light display-6">SRS</h1>
                                                    <p>Sistema de Registro de Solicitudes</p>
                                                </div>
                                            </div>
                                        </div>

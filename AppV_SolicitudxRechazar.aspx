...
<script runat="server">
    ...
    Sub SP_SetSolicitudxCancelar()
        ...
        Try
            ...
            If registro.Read Then
                ...
                Response.Write("<script>window.open('AppV_SolicitudxAprobar.aspx',target='_self');<" & "/" & "script>")
            Else
    ...
    Sub SP_SetSolicitudxAprobar()
        ...
        Try
            ...
            miParam6.Direction = ParameterDirection.Input
            coDetalle.Parameters.Add(miParam6)
            coDetalle.Parameters("@Sot_Clave").Value = 4 ' Por Comprar
    ...
    Sub SP_GetSolicitudxFiltro()
        ...
        Try
            ...
            coDetalle.Parameters("@Sot_Clave").Value = 6 ' rechazadas
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Solicitudes / Por Rechazar</strong>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <!-- .table-stats -->
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <asp:Button ID="Btn_Aceptar" runat="server" OnClick="SP_SetSolicitudxAprobar" class="btn btn-success btn-sm" Text="Aceptar" />
                                                    </div>

...
<script runat="server">
    ...
    Sub ISP_GetSolicitudInsumo()
        ...
        Try
            ...
            coDetalle.Parameters("@ISot_Clave").Value = 1 'Por Validar
    ...
    Protected Sub Btn_Modificar_Click(sender As Object, e As EventArgs)
        ...
        If Session("vs_PerClave") = "3" Or Session("vs_PerClave") = "1" Then
            If Txt_MotivoRech.Text.Trim.Length > 0 Then
                Alert("Se capturo Motivo de Rechazo, favor de eliminar dicho Motivo.")
                Exit Sub
            End If
        End If
    ...
    Sub ISP_SetSolicitudInsumoxFiltro()
        ...
        Try
            ...
            If registro.Read Then
                ...
                Response.Write("<script>window.open('AppI_SolicitudxValidar.aspx',target='_self');<" & "/" & "script>")
            Else
    ...
    Sub SP_SetSolicitudxCancelar()
        ...
        Try
            If Txt_MotivoRech.Text.Trim.Length = 0 Then
                Alert("No se capturo Motivo de Rechazo, favor de capturarlo.")
                Exit Sub
            End If
            ...
            miParam1.Direction = ParameterDirection.Input
            coDetalle.Parameters.Add(miParam1)
            coDetalle.Parameters("@ISot_Clave").Value = 6 ' Por Aprobar

            Dim miParam2 As New SqlParameter("@ISol_MotRech", SqlDbType.VarChar)
            miParam2.Direction = ParameterDirection.Input
            coDetalle.Parameters.Add(miParam2)
            coDetalle.Parameters("@ISol_MotRech").Value = Txt_MotivoRech.Text.Trim   ' Por Aprobar
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Solicitud Clave: <%=Session("Vs_ClaveTexto") & "  " %> Por Validar</strong>
                                </div>
                                <div class="card-body card-block">
                                    <!-- .table-stats -->
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        <asp:Label ID="Lbl_Cancelar" for="input-small" class=" form-control-label" runat="server" Text="Motivo de Rechazo (Solo en caso de Rechazar) :"></asp:Label>
                                                        <div class="input-group">
                                                            <div class="input-group-addon"><i class="fa fa-key"></i></div>
                                                            <asp:TextBox ID="Txt_MotivoRech" runat="server" Rows="4" MaxLength ="255" class="form-control" TextMode="MultiLine"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <asp:Button ID="Btn_Cancelar" runat="server" OnClick="SP_SetSolicitudxCancelar" class="btn btn-danger btn-sm" Text="Rechazar" />
                                                    </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-4">
                                                        <asp:Button ID="Btn_Guardar_Else" OnClick="ISP_SetSolicitudInsumoxFiltro" runat="server"  class="btn btn-success btn-sm" Text="Aceptar" />
                                                    </div>

                                                    <div class="form-group col-md-4">
                                                        <asp:Button ID="Btn_Modificar_Else" runat="server" OnClick="Btn_Modificar_Click"  class="btn btn-success btn-sm" Text="Modificar" />
                                                    </div>

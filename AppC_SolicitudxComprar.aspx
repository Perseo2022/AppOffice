...
<script runat="server">
    ...
    Dim Vg_FileCotizacion As String
    ...
    Sub CSP_GetSolicitudCompras()
        ...
        coDetalle.Parameters("@CSot_Clave").Value = 5 'Por Comprar
    ...
    Protected Sub UploadBtn_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If UploadButton.Text = "Agregar Recibo" Then
            ...
            If (FileUpload1.HasFile) Then
                ...
                If (extension = "PDF") Or (extension = ".PDF") Then
                    ...
                    Lbl_FileName.Text = FileUpload1.FileName
                    UploadStatusLabel.BackColor = System.Drawing.Color.Green
                    UploadStatusLabel.Text = "Cargado."
                    UploadButton.Text = "Borrar Recibo"
                    CSP_SetSolicitudComprasxFileRec()
                    FileUpload1.Visible = False
                Else
                    ' Notify the user why their file was not uploaded.
                    UploadStatusLabel.BackColor = System.Drawing.Color.Red
                    UploadStatusLabel.Text = "No Cargado."
                    Lbl_FileName.Text = ""
                End If
            ...
            Else
                ...
                UploadStatusLabel.BackColor = System.Drawing.Color.Red
                UploadStatusLabel.Text = "No Seleccionado."
                Lbl_FileName.Text = ""
            End If
        ElseIf UploadButton.Text = "Borrar Recibo" Then
            ...
            UploadButton.Text = "Agregar Recibo"
            Lbl_FileName.Text = ""
            CSP_SetSolicitudComprasxFileRec()
        End If
    End Sub

    Sub CSP_SetSolicitudComprasxFileRec()
        Dim vl_Respuesta As String = ""
        Dim myConnection As SqlConnection
        ...
        'El CommandType = StoreProcedure y la conexion
        Dim coDetalle As New SqlCommand
        coDetalle.CommandText = "AppC_SPSetSolicitudComprasxFileRec"
        coDetalle.CommandType = CommandType.StoredProcedure
        coDetalle.Connection = myConnection  'Previamente definida
        ...
        If Not Lbl_FileName.Text.Equals("") Then
            Dim miParam2 As New SqlParameter("@CSol_FileRec", SqlDbType.VarChar)
            miParam2.Direction = ParameterDirection.Input
            coDetalle.Parameters.Add(miParam2)
            coDetalle.Parameters("@CSol_FileRec").Value = Lbl_FileName.Text.Trim
        End If
        ...
        If registro.Read Then
            'Response.Write("<script>javascript: alert('Solicitud Validada C ');<" & "/" & "script>")
            'Server.Transfer("AppC_SolicitudxValidarC.aspx")
        Else
            MsgBox("Ocurrio un Error. Favor de contactar al Administrador del Sistema.", MsgBoxStyle.Critical, "AppCompras")
        End If
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Solicitud Clave: <%=Session("Vs_ClaveTexto") & "  " %> Por Comprar</strong>
                                </div>
                                        ...
                                        <tbody>
                                                ...
                                                <td colspan="3" width="100%">
                                                    ...
                                                    <div class="form-group">
                                                        <asp:GridView ID="GV_Solicitud" runat="server" Width="100%" OnRowDataBound="GV_Solicitud_RowDataBound"
                                                            ...
                                                            DataKeyNames="CSol_ClavePres,CSol_Clave,Sec_Clave,CSot_Clave,InT_Clave,IEn_Clave,Sec_Descripcion, CSol_FileCotizacion">
                                            ...
                                            <tr>
                                                ...
                                                <td width="30%">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <asp:Button id="UploadButton" Text="Agregar Recibo" OnClick="UploadBtn_Click" runat="server"></asp:Button>   
                                                        </div>
                                                    </div>
                                                </td>
                                                <td width="10%">

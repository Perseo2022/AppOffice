...
<body>
                 ...
                 <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="ti-agenda"></i><asp:HyperLink ID="HyperLink11" NavigateUrl ="AppE_Reportes.aspx" runat="server">Mensual por Proveedor</asp:HyperLink></li>
                            <% End If %>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
           ...
           <form id="form1" method = "post" runat="server" target="_self">
                <input type="hidden" name="IdEvento" id="IdStatusActual" value="4">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Reporte de Eventos Aprobados</strong>
                    </div>
                    <div class="card-body">
				...
				<tbody>
                                       ...
                                       <button id="BtnDowload" class="btn btn-primary">Descargar <i class="fa fa-cloud-download" aria-hidden="true"></i></button>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var wb = XLSX.utils.table_to_book(document.getElementById('listaEventos'), { sheet: "Sheet JS" });
            ...
            $("#BtnDowload").click(function () {
                saveAs(new Blob([s2ab(wbout)], { type: "application/octet-stream" }), 'ReporteAprobados.xlsx');
            });

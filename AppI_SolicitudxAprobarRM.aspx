    ...
    Sub ISP_SetSolicitudInsumoxFiltro()
        ...
        Try
            ...
            If registro.Read Then
                ...
                Alert("Solicitud Aprobada RM")
                Response.Write("<script>window.open('AppI_SolicitudxAprobarRM.aspx',target='_self');<" & "/" & "script>")
            Else
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Solicitudes / Por Aprobar RM</strong>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Solicitud Clave: <%=Session("Vs_ClaveTexto") & "  " %> Por Aprobar RM</strong>
                                </div>

...
<script runat="server">
    ...
    Sub ISP_GetSolicitudInsumo()
        ...
        Try
            ...
            coDetalle.Parameters("@ISot_Clave").Value = 4 'Por Surtir
    ...
    Protected Sub GV_Insumos_SelectedIndexChanged(sender As Object, e As EventArgs)
        ...
        Try
            Session("Vs_CveProd") = Convert.ToString(GV_Insumos.DataKeys(row.RowIndex).Values("CveProd"))
            Session("Vs_Prod_Descripcion") = Convert.ToString(GV_Insumos.DataKeys(row.RowIndex).Values("Prod_Descripcion"))
            Session("Vs_UnM_Descripcion") = Convert.ToString(GV_Insumos.DataKeys(row.RowIndex).Values("UnM_Descripcion"))
            Session("Vs_Ins_Cantidad") = Convert.ToString(GV_Insumos.DataKeys(row.RowIndex).Values("Ins_Cantidad"))
            Session("Vs_[Ins_Clave]") = Convert.ToString(GV_Insumos.DataKeys(row.RowIndex).Values("[Ins_Clave]"))
            Session("Vs_Prod_Clave") = Convert.ToString(GV_Insumos.DataKeys(row.RowIndex).Values("Prod_Clave"))
            Session("Vs_ISol_Clave") = Convert.ToString(GV_Insumos.DataKeys(row.RowIndex).Values("ISol_Clave"))
            Session("Vs_UnM_Clave") = Convert.ToString(GV_Insumos.DataKeys(row.RowIndex).Values("UnM_Clave"))
            Session("Vs_Ins_Estatus") = Convert.ToString(GV_Insumos.DataKeys(row.RowIndex).Values("Ins_Estatus"))
            Session("Vs_TraeCve") = 1

            Text_CveProd.Text = Convert.ToString(GV_Insumos.DataKeys(row.RowIndex).Values("CveProd"))
            Text_Prod_Descripcion.Text = Convert.ToString(GV_Insumos.DataKeys(row.RowIndex).Values("Prod_Descripcion"))
            Text_UnM_Descripcion.Text = Convert.ToString(GV_Insumos.DataKeys(row.RowIndex).Values("UnM_Descripcion"))
            Text_Ins_Cantidad.Text = Convert.ToString(GV_Insumos.DataKeys(row.RowIndex).Values("Ins_Cantidad"))
            Text_Ins_Clave.Text = Convert.ToString(GV_Insumos.DataKeys(row.RowIndex).Values("Ins_Clave"))
            Text_ISol_Clave.Text = Convert.ToString(GV_Insumos.DataKeys(row.RowIndex).Values("ISol_Clave"))
    ...
    Protected Sub Btn_Modificar_Cantidad_Click()
        Dim myConnection As SqlConnection
        ...
        Try
            ...
            'El CommandType = StoreProcedure y la conexion
            Dim coDetalle As New SqlCommand
            coDetalle.CommandText = "AppI_SPUpdateInsumos"
            coDetalle.CommandType = CommandType.StoredProcedure
            coDetalle.Connection = myConnection  'Previamente definida
            ...
            miParam.Direction = ParameterDirection.Input
            coDetalle.Parameters.Add(miParam)
            coDetalle.Parameters("@ISol_Clave").Value = CInt(Text_ISol_Clave.Text)

            Dim miParam2 As New SqlParameter("@Ins_Clave", SqlDbType.Int)
            miParam.Direction = ParameterDirection.Input
            coDetalle.Parameters.Add(miParam2)
            coDetalle.Parameters("@Ins_Clave").Value = CInt(Text_Ins_Clave.Text)

            Dim miParam3 As New SqlParameter("@Ins_Cantidad", SqlDbType.Int)
            miParam.Direction = ParameterDirection.Input
            coDetalle.Parameters.Add(miParam3)
            coDetalle.Parameters("@Ins_Cantidad").Value = CInt(Text_Ins_Cantidad.Text)
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Solicitudes / Por Surtir</strong>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Solicitud Clave: <%=Session("Vs_ClaveTexto") & "  " %> Por Surtir</strong>
                                </div>
                                <div class="card-body card-block">
                                    <!-- .table-stats -->
                                           ...
                                           <div class="form-row">
                                            <div class="form-group col-md-12">
                                             <asp:GridView ID="GV_Insumos" runat="server" Width="100%" OnRowDataBound="GV_Insumos_RowDataBound"
                                                ...
                                                DataKeyNames="CveProd, Prod_Descripcion, UnM_Descripcion, Ins_Cantidad, Ins_Clave, Prod_Clave, ISol_Clave, UnM_Clave, Ins_Estatus ">
                                        ...
                                        <!-- Solicitud GEVS 10/05/2021-->
                                        <div class="col-lg-12 col-md-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <strong>Solicitud: <%=Session("Vs_ClaveTexto") %> </strong>
                                                </div>
                                            <div class="card-body card-block">
                                            <!-- .table-stats -->
                                                ...
                                                <div class="form-group col-md-3">
                                                     ...
                                                     <div class="input-group">
                                                         <div class="input-group">
                                                            <div class="input-group-addon"><i class="fa fa-sign-in"></i></div>
                                                                <asp:TextBox ID="Text_CveProd" disabled="true" class="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                         </div>
                                                     </div>
                                                 </div>
                                                 <div class="form-group col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon"><i class="fa fa-sign-in"></i></div>
                                                                <asp:TextBox ID="Text_Prod_Descripcion" disabled="true" class="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                 </div>
                                                 <div class="form-group col-md-2">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon"><i class="fa fa-sign-in"></i></div>
                                                                <asp:TextBox ID="Text_UnM_Descripcion" disabled="true" class="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                            </div>
                                                         </div>
                                                     </div>
                                                 <div class="form-group col-md-1">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon"><i class="fa fa-sign-in"></i></div>
                                                                <asp:TextBox ID="Text_Ins_Cantidad" class="input-sm form-control-sm form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                     </div>
                                                     <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                <asp:Button ID="Button1" runat="server" OnClick="Btn_Modificar_Cantidad_Click"  class="btn btn-success btn-sm" Text="Modificar" />
                                                            </div>
                                                    </div>
                                                    <div class="form-group col-md-1">
                                                        <label class=" form-control-label" style="display:none;">Clave</label>
                                                    <div class="input-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon" style="display:none;"><i class="fa fa-sign-in"></i></div>
                                                                <asp:TextBox ID="Text_Ins_Clave" class="input-sm form-control-sm form-control" runat="server" MaxLength="50" Visible="false"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                     </div>
                                                     <div class="form-group col-md-1">
                                                         ...
                                                         <div class="input-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon" style="display:none;"><i class="fa fa-sign-in"></i></div>
                                                                    <asp:TextBox ID="Text_ISol_Clave" class="input-sm form-control-sm form-control" runat="server" MaxLength="50" Visible="false"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                     </div>
                                                   </div>  
                                         ...
                                         <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <asp:Button ID="Btn_Modificar" runat="server" OnClick="Btn_Modificar_Click"  class="btn btn-success btn-sm" Text="Por Confirmar" />
                                            </div>
                                         </div>
                                        <!-- /.table-stats -->
                                    </div>

...
<script runat="server">
    ...
    Sub CSP_GetSolicitudCompras()
        ...
        coDetalle.Parameters("@CSot_Clave").Value = 2 'Por ValidarE
    ...
    Sub CSP_SetSolicitudComprasxFiltro()
        ...
        If registro.Read Then
            ...
            Server.Transfer("AppC_SolicitudxAprobarCE.aspx")
        Else
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Solicitudes / Por Aprobar CE</strong>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Solicitud Clave: <%=Session("Vs_ClaveTexto") & "  " %> Por Aprobar CE</strong>
                                </div>

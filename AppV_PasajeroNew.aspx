...
<script runat="server">
    ...
    Sub SP_SetPasajeroNew()
        ...
        If ValidaCampos() Then
            ...
            'El CommandType = StoreProcedure y la conexion
            Dim coDetalle As New SqlCommand
            coDetalle.CommandText = "AppV_SPSetPasajeroNew"
            coDetalle.CommandType = CommandType.StoredProcedure
            coDetalle.Connection = myConnection  'Previamente definida
            ...
            'Parámetros si hubieran
            Dim miParam As New SqlParameter("@Pas_Nombre", SqlDbType.VarChar)
            miParam.Direction = ParameterDirection.Input
            coDetalle.Parameters.Add(miParam)
            coDetalle.Parameters("@Pas_Nombre").Value = Txt_Nombre.Text.Trim

            Dim miParam1 As New SqlParameter("@Pas_ApPaterno", SqlDbType.VarChar)
            miParam1.Direction = ParameterDirection.Input
            coDetalle.Parameters.Add(miParam1)
            coDetalle.Parameters("@Pas_ApPaterno").Value = Txt_ApPaterno.Text.Trim

            Dim miParam2 As New SqlParameter("@Pas_ApMaterno", SqlDbType.VarChar)
            miParam2.Direction = ParameterDirection.Input
            coDetalle.Parameters.Add(miParam2)
            coDetalle.Parameters("@Pas_ApMaterno").Value = Txt_ApMaterno.Text.Trim
            ...
            Dim miParam7 As New SqlParameter("@Sec_Clave", SqlDbType.Int)
    ...
    Function ValidaCampos() As Boolean
        ...
        If Txt_Nombre.Text.Trim.Equals("") Then
            Response.Write("<script>javascript: alert('Seleccione un Nombre');<" & "/" & "script>")
            Exit Function
        End If
        If Txt_ApPaterno.Text.Trim.Equals("") Then
            Response.Write("<script>javascript: alert('Seleccione un Apellido Paterno');<" & "/" & "script>")
            Exit Function
        End If
        If Txt_ApMaterno.Text.Trim.Equals("") Then
            Response.Write("<script>javascript: alert('Seleccione un Apellido Materno');<" & "/" & "script>")
            Exit Function
        End If
        ...
        ValidaCampos = True
        If DDL_Secretarias.SelectedIndex <= 0 Then
            Response.Write("<script>javascript: alert('Seleccione una Secretaria');<" & "/" & "script>")
            Exit Function
        End If
    End Function
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Pasajeros / Nuevo</strong>
                    </div>
                    <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td width="33%">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group">
                                                                <asp:Button ID="Btn_Aceptar" runat="server" Text="Aceptar" class="btn btn-success btn-sm" onclick="SP_SetPasajeroNew" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>

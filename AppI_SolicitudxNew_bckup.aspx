    ...
    Sub ISP_SetSolicitudNew()
        ...
        Try
            ...
            If DDL_UniPptal.SelectedIndex > 0 Then
                Dim miParam2 As New SqlParameter("@IUptal_Clave", SqlDbType.Char)
                miParam2.Direction = ParameterDirection.Input
                coDetalle.Parameters.Add(miParam2)
                coDetalle.Parameters("@IUptal_Clave").Value = CInt(DDL_UniPptal.Items(DDL_UniPptal.SelectedIndex).Value)
            End If

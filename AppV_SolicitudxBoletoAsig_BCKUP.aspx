...
<script runat="server">
    ...
    Sub SP_GetSolicitudxFiltro()
        ...
        Try
            ...
            coDetalle.Parameters("@Sot_Clave").Value = 5 ' Por boleto asignado
    ...
    Protected Sub GV_Pasajero_SelectedIndexChanged(sender As Object, e As EventArgs)
        ...
        Try
            ...
            nameFile = Convert.ToString(GV_Pasajero.DataKeys(row.RowIndex).Values("Sol_Boleto"))
            nameFile_1 = Convert.ToString(GV_Pasajero.DataKeys(row.RowIndex).Values("Sol_Archivo"))
            Txt_Reservacion.Text = Convert.ToString(GV_Pasajero.DataKeys(row.RowIndex).Values("Sol_Reservacion"))
            If Convert.ToString(GV_Pasajero.DataKeys(row.RowIndex).Values("Sol_Boleto")).Length > 60 Then
                Lbl_Boleto.Text = Convert.ToString(GV_Pasajero.DataKeys(row.RowIndex).Values("Sol_Boleto")).Substring(0, 60) + "..."
            ElseIf Convert.ToString(GV_Pasajero.DataKeys(row.RowIndex).Values("Sol_Boleto")).Length < 60 Then
                Lbl_Boleto.Text = Convert.ToString(GV_Pasajero.DataKeys(row.RowIndex).Values("Sol_Boleto"))
            End If
            Txt_SolClave.Text = Convert.ToString(GV_Pasajero.DataKeys(row.RowIndex).Values("Sol_Clave"))

            Lbl_Nombre_1.Text = Me.GV_Pasajero.SelectedRow.Cells(14).Text & " " &
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Solicitudes / Boleto Asignado</strong>
                        </div>
                        <div class="card-body">
                                        ...
                                        <!-- .table-stats -->
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                            ...
                                                            Sol_DetalleVuelo,Sol_ObjPartidista,ReT_Clave,VuT_Clave, Age_Descripcion, Aer_Descripcion, Sol_Archivo, Sol_Costo,
                                                                Sol_Comentarios, Sol_Boleto, Sol_Reservacion, Sol_Clave"
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Reservacion: </strong><asp:Label ID="Lbl_Nombre_1" runat="server" Text=""></asp:Label>
                                    </div>
                                    <div class="card-body card-block">
                                        <!-- .table-stats -->
                                        <div class="form-row">
                                            <div class="form-group col-md-7">
                                                <label class=" form-control-label">Boleto / Reservacion</label>
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i class="fa fa-home"></i></div>
                                                    <asp:Label ID="Lbl_Boleto" disabled="true" class="form-control" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-5">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i class="fa fa-home"></i></div>
                                                    <asp:TextBox ID="Txt_Reservacion" disabled="true" runat="server" class="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i class="fa fa-key"></i></div>
                                                    <asp:TextBox ID="Txt_SolClave" runat="server" disabled="true"></asp:TextBox>
                                                    <asp:Label ID="Txt_Archivo" Visible = false disabled="" class="form-control" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label class=" form-control-label">Formato de Requesición</label>
                                                <div class="input-group">
                                                    <button id="DowloadRepor" class="btn btn-success">Descargar <i class="fa fa-cloud-download" aria-hidden="true"></i></button>
                                                </div>
                                            </div>

                                            <div class="form-group col-md-4">
                                                <label class=" form-control-label">Abrir Boleto / Cotizacion</label>
                                                <div class="input-group">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                <label class=" form-control-label">Descargar Boleto / Cotizacion</label>
                                                <div class="input-group">
                                                    <a href="./cotizacion/<%=Txt_Archivo.Text %>" download="<%=Txt_Archivo.Text %>"><img alt="" src="./images/download.png" /></a>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label class=" form-control-label">Abrir Boleto / Reservacion</label>
                                                <div class="input-group">
                                                    <a href="./CotCompras/<%=nameFile %>" target="_blank" ><img alt="" src="./images/Ver.jpg" /></a>
                                                </div>
                                            </div>

                                            <div class="form-group col-md-4">
                                                <label class=" form-control-label">Descargar Boleto / Reservacion</label>
                                                <div class="input-group">
                                                    <a href="./CotCompras/<%=nameFile %>" download="<%=nameFile %>"><img alt="" src="./images/download.png" /></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#GV_Pasajero').on('click', 'tr td', function (evt) {
                $('#Txt_SolClave').val() = $(this).parents("tr").find("td").eq(1).text();
            });
           // $('#bootstrap-data-table-export').DataTable();
            $("#DowloadRepor").click(function () {
                var codigo = $('#Txt_SolClave').val();
                //var codigo = "CFBGIN";
                alert("Desea bajar la requisicion numero: " + codigo);
                //await sleep(3000);
                descarga(codigo);

...
<script runat="server">
    ...
    Sub CSP_GetSolicitudCompras()
        ...
        coDetalle.Parameters("@CSot_Clave").Value = 8 'Por Notificar
    ...
    Sub CSP_GetCompras()
        ...
        miParam1.Direction = ParameterDirection.Input
        coDetalle.Parameters.Add(miParam1)
        coDetalle.Parameters("@Com_Estatus").Value = "O"
    ...
    Sub CSP_SetSolicitudComprasxFiltro()
        ...
        miParam1.Direction = ParameterDirection.Input
        coDetalle.Parameters.Add(miParam1)
        coDetalle.Parameters("@CSot_Clave").Value = 9 ' Aceptado
        ...
        If registro.Read Then
            ...
            Response.Write("<script>javascript: alert('Solicitud Aceptada');<" & "/" & "script>")
            Server.Transfer("AppC_SolicitudxNotificar.aspx")
        Else
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Solicitudes / Por Notificar</strong>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Solicitud Clave: <%=Session("Vs_ClaveTexto") & "  " %> Por Notificar</strong>
                                </div>
                                <div class="card-body card-block">
                                    ...
                                    <table class="table ">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="3" width="30%"  style="text-align:center">
                                                    <div class="form-group">

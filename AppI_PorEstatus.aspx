...
<script runat="server">
    ...
    Sub ISP_GetSolicitudTipo()
        ...
        Try
            ...
            'El CommandType = StoreProcedure y la conexion
            Dim coDetalle As New SqlCommand
            coDetalle.CommandText = "AppI_SPGetSolicitudTipo"
            coDetalle.CommandType = CommandType.StoredProcedure
            coDetalle.Connection = myConnection  'Previamente definida
            ...
            DDL_Estatus.DataTextField = "ISot_Descripcion"
            DDL_Estatus.DataValueField = "ISot_Clave"
    ...
    Sub ISP_GetSolicitudInsumo()
        ...
        Try
            ...
            If DDL_Estatus.SelectedIndex > 0 Then
                ...
                coDetalle.Parameters("@ISot_Clave").Value = CInt(DDL_Estatus.Items(DDL_Estatus.SelectedIndex).Value)
            End If
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <strong id="Isumoclave">Solicitud Clave: <%=Session("Vs_ClaveTexto") & "  " %></strong>
                                </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <asp:GridView ID="GV_Solicitud" runat="server" Width="100%" OnRowDataBound="GV_Solicitud_RowDataBound"
                                                ...
                                                DataKeyNames="ISol_ClavePres,ISol_Clave,Sec_Clave,ISot_Clave,InT_Clave,IEn_Clave,Sec_Descripcion" ShowHeaderWhenEmpty="True">

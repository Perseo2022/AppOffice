...
<script runat="server">
    ...
    Sub SP_SetSolicitudxComprar()
        ...
        Try
            ...
            'El CommandType = StoreProcedure y la conexion
            Dim coDetalle As New SqlCommand
            coDetalle.CommandText = "AppV_SPSetSolicitudxComprar"
            coDetalle.CommandType = CommandType.StoredProcedure
            coDetalle.Connection = myConnection  'Previamente definida
            ...
            Dim miParam1 As New SqlParameter("@Sol_Reservacion", SqlDbType.VarChar)
            miParam1.Direction = ParameterDirection.Input
            coDetalle.Parameters.Add(miParam1)
            coDetalle.Parameters("@Sol_Reservacion").Value = Txt_Reservacion.Text.Trim

            Dim miParam2 As New SqlParameter("@Sol_Boleto", SqlDbType.VarChar)
            miParam2.Direction = ParameterDirection.Input
            coDetalle.Parameters.Add(miParam2)
            coDetalle.Parameters("@Sol_Boleto").Value = Lbl_FileName.Text.Trim

            Dim miParam6 As New SqlParameter("@Sot_Clave", SqlDbType.VarChar)
            ...
            If registro.Read Then
                ...
                Alert("Boleto Asignado")
                Response.Write("<script>window.open('AppV_SolicitudxComprar.aspx',target='_self');<" & "/" & "script>")
            Else
    ...
    Sub SP_GetSolicitudxFiltro()
        ...
        Try
            ...
            coDetalle.Parameters("@Sot_Clave").Value = 4 ' Por Aprobar
    ...
    Protected Sub UploadBtn_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim savePath As String = Server.MapPath("~/CotCompras/")

        Try
            If UploadButton.Text = "Agregar Boleto" Then
                ...
                Else
                    ...
                    Lbl_FileName.Text = ""
                End If
            ElseIf UploadButton.Text = "Borrar Boleto" Then
                ...
                UploadButton.Text = "Agregar Boleto"
                Lbl_FileName.Text = ""
            End If
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Solicitudes / Por Comprar</strong>
                    </div>
                    <div class="card-body">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        <asp:GridView ID="GV_Pasajero" runat="server" Width="100%" OnRowDataBound="GV_Pasajero_RowDataBound"
                                                            ...
                                                            Sol_DetalleVuelo,Sol_ObjPartidista,ReT_Clave,VuT_Clave, Age_Descripcion, Aer_Descripcion, Sol_Archivo, Sol_Costo,Sol_Comentarios"
                                    ...
                                    <!-- .table-stats -->
                                                <div class="form-row">
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group">
                                                                ...
                                                                <asp:TextBox ID="Txt_Origen" ReadOnly class="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <asp:TextBox ID="Txt_Destino" ReadOnly class="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                                <asp:TextBox ID="Txt_DateFlyExit"  ReadOnly  class="form-control" runat="server"  MaxLength="10"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                            <asp:TextBox ID="Txt_HourFlyExit"  ReadOnly runat="server"  MaxLength="5" class="form-control"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                            <asp:TextBox ID="Txt_DateFlyRet"  ReadOnly class="form-control"  MaxLength="10" runat="server" data-toggle="modal" data-target="#FechaModalRet"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                            <asp:TextBox ID="Txt_HourFlyRet" ReadOnly runat="server"  MaxLength="5" class="form-control"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <asp:TextBox ID="Txt_DetailFly"  ReadOnly runat="server" Rows="4" class="form-control" TextMode="MultiLine"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group-addon"><i class="fa fa-th-large"></i></div>
                                                            <asp:TextBox ID="Txt_ObPartido"  ReadOnly runat="server" Rows="4" class="form-control" TextMode="MultiLine"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <!-- .table-stats -->
                                                <div class="form-row">
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <asp:TextBox ID="Txt_Agencia" ReadOnly  class="form-control" runat="server"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon"><i class="fa fa-plane"></i></div>
                                                                <asp:TextBox ID="Txt_Aerolinea" ReadOnly class="form-control" runat="server"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <asp:TextBox ID="Txt_Costo" ReadOnly class="form-control" runat="server" MaxLength="50"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group-addon"><i class="fa fa-home"></i></div>
                                                            <asp:Label ID="Txt_Archivo" ReadOnly class="form-control" runat="server"></asp:Label>
                                                        </div>
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label class=" form-control-label">Abrir Cotizacion</label>
                                                        <div class="input-group">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group-addon"><i class="fa fa-th-large"></i></div>
                                                            <asp:TextBox ID="Txt_Comentarios" runat="server" Rows="4" ReadOnly class="form-control" TextMode="MultiLine"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                    <!-- /.table-stats -->
                                    ...
                                    <!-- .table-stats -->
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <div class="input-group">
                                                            <asp:Button id="UploadButton" Text="Agregar Boleto" OnClick="UploadBtn_Click" runat="server"></asp:Button>   
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-4">
                                                        <label class=" form-control-label">Clave de Reservacion</label>
                                                        <div class="input-group">
                                                            <div class="input-group-addon"><i class="fa fa-home"></i></div>
                                                            <asp:TextBox ID="Txt_Reservacion" MaxLength="8" runat="server" class="form-control"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            <asp:Button ID="Btn_Aceptar" runat="server" OnClick="SP_SetSolicitudxComprar" class="btn btn-success" Text="Ok" />
                                                        </div>
                                                    </div>
                                                </div>
                                    <!-- /.table-stats -->

...
<script runat="server">
    ...
    Sub CSP_GetSolicitudCompras()
        ...
        coDetalle.Parameters("@CSot_Clave").Value = 3 'Por Validar C
    ...
    Sub CSP_SetSolicitudComprasxFiltro()
        ...
        miParam1.Direction = ParameterDirection.Input
        coDetalle.Parameters.Add(miParam1)
        coDetalle.Parameters("@CSot_Clave").Value = 4 ' Por Aprobar SA

        Dim miParam2 As New SqlParameter("@CSol_FileCot", SqlDbType.VarChar)
        miParam2.Direction = ParameterDirection.Input
        coDetalle.Parameters.Add(miParam2)
        coDetalle.Parameters("@CSol_FileCot").Value = Lbl_FileName.Text.Trim
    ...
    Protected Sub UploadBtn_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If UploadButton.Text = "Agregar Cotizacion" Then
            ...
            If (FileUpload1.HasFile) Then
                ...
                If (extension = "pdf") Or (extension = ".pdf") _
                    ...
                    'savePath += fileName
                    savePath += Session("Vs_Clave") + "_" + fileName
                    ...
                    Lbl_FileName.Text = Session("Vs_Clave") + "_" + FileUpload1.FileName
                    UploadStatusLabel.BackColor = System.Drawing.Color.Green
                    UploadStatusLabel.Text = "Cargado."
                    UploadButton.Text = "Borrar Cotizacion"
            ...
            Else
                ...
                Lbl_FileName.Text = ""
            End If
        ElseIf UploadButton.Text = "Borrar Cotizacion" Then
            ...
            UploadButton.Text = "Agregar Cotizacion"
            Lbl_FileName.Text = ""
        End If
    End Sub
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Solicitudes / Por Validar C</strong>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Solicitud Clave: <%=Session("Vs_ClaveTexto") & "  " %> Por Validar C</strong>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td width="30%">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <asp:Button id="UploadButton" Text="Agregar Cotizacion" OnClick="UploadBtn_Click" runat="server"></asp:Button>   
                                                        </div>
                                                    </div>
                                                </td>
                                                <td width="10%">
